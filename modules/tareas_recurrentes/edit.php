...
$page_title = 'Editar Tarea Recurrente';
...
$tarea = $conn->query("SELECT * FROM tareas_recurrentes WHERE id_tarea_recurrente = $id")->fetch();
if (!$tarea) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf_token($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($errors)) {
            try {
                $stmt = $conn->prepare("
                    ...
                    WHERE id_tarea_recurrente = ?
                ");
                $stmt->execute([$titulo, $descripcion ?: null, $prioridad, $estado, $id]);
                redirect(SITE_URL . '/modules/tareas_recurrentes/list.php?success=' . urlencode('Tarea recurrente actualizada correctamente.'));
            } catch (Exception $e) {
        ...
        $tarea['titulo']      = $_POST['titulo'] ?? $tarea['titulo'];
        $tarea['descripcion'] = $_POST['descripcion'] ?? $tarea['descripcion'];
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3"><i class="bi bi-pencil"></i> Editar Tarea Recurrente</h1>
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descripcion" name="descripcion" rows="3"
                          placeholder="Detalle de la tarea..."><?php echo htmlspecialchars($tarea['descripcion'] ?? ''); ?></textarea>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="prioridad" name="prioridad">
                        ...
                        <option value="<?php echo $v; ?>" <?php echo ($tarea['prioridad'] === $v) ? 'selected' : ''; ?>>
                            <?php echo $l; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="estado" name="estado">
                        ...
                        <option value="inactiva" <?php echo ($tarea['estado'] === 'inactiva') ? 'selected' : ''; ?>>Inactiva</option>
                    </select>
                </div>
            </div>
